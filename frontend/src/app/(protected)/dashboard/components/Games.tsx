  ...
  return (
    <div className="bg-[#0F0F0F]/75 rounded-[20px] basis-4/10 p-4 flex flex-col h-full">
      ...
      <div className="flex flex-col gap-4 w-full flex-1">
        ...
        <div className="relative w-full flex-1 min-h-35 rounded-xl overflow-hidden group cursor-pointer">
          <Image
          ...
          <div className="absolute bottom-0 w-full h-24 bg-linear-to-t from-black via-black/80 to-transparent"></div>
