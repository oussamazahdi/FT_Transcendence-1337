...
import FriendsRequests from './components/FriendsRequests.tsx'
...
const FriendsRequestsPage = () => {
  ...
  return (
    <div className='w-[90vw] min-h-[88vh] md:min-h-0 md:h-[86vh] flex flex-col bg-[#0F0F0F]/75 rounded-xl gap-4 md:px-60 overflow-hidden'>
