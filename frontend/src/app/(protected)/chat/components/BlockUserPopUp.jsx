  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 bg-[#0f0f0f] py-10 px-16 rounded-4xl shadow-2xl w-[80%] md:w-100 flex flex-col items-center ">
        ...
        <p className="font-bold text-lg md:text-xl">Block {user.name}</p>
        <p className='text-center text-gray-500 text-xs md:text-xs'>This person won’t be able to message or invite you, They wont know you blocked theme</p>
