  ...
  const localGameItems = [
    {
      ...
      alt: "1vs1 cover",
      description: "Play a Ping Pong game with your friends locally or remotely",
      button: "Start Game"
    },
    {
	 titel: "Tic Tac Toe",
	 ...
	 alt: "XO game cover",
	 description: "Play a Tic Tac Toe game with your friends locally or remotely.",
	 button: "Start Game"
    }
  ];
    ...
    return (
      <div className='flex items-center grid grid-cols-1 lg:grid-cols-2 w-full max-w-7xl'>
				...
				<div className='rounded-3xl bg-[#0F0F0F]/60 px-3 pt-3 text-center m-3'>
					...
					<p className='pb-3 text-[#D5D5D5]/60'>{localGameItems[0].description}</p>
