...
const LocalGame = () => {
	...
	return (
		<div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 w-full max-w-7xl'>
			...
			<div key={localGameItems[0].titel} className='rounded-3xl bg-[#0F0F0F]/65 my-3 px-3 pt-3 text-center'>
				<img src={localGameItems[0].cover} alt={localGameItems[0].alt} className='w-full h-110 object-cover rounded-xl'/>
			...
			<div key={localGameItems[1].titel} className='rounded-3xl bg-[#0F0F0F]/65 my-3 px-3 pt-3 text-center'>
			...
			<div key={localGameItems[2].titel} className='rounded-3xl bg-[#0F0F0F]/65 my-3 px-3 pt-3 text-center'>
