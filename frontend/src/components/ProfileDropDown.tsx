...
const ProfileDropDown = ({ user }: ProfileDropDownProps) => {
  ...
  return (
    <div ref={ref} className="relative shrink-0">
      ...
      {isOpen ? (
        <div className="absolute right-1 top-full mt-5 w-36 md:w-56 bg-[#000000]/75 rounded-xl flex flex-col justify-center items-center text-white font-medium p-2 z-10">
          <ul className="w-full space-y-1">
            <Link
              ...
              href="/profile"
              className="h-8 md:h-10  flex justify-start items-center gap-3 rounded-lg hover:bg-[#414141]/70 cursor-pointer transition-colors"
            >
            ...
            <Link
              onClick={() => setIsOpen(!isOpen)}
              href="/settings"
              className="h-8 md:h-10  w-full max-w-52 flex justify-start items-center gap-3 rounded-lg hover:bg-[#414141]/70 cursor-pointer transition-colors"
            >
