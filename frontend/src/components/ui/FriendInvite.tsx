...
export const FriendInvite = ({ notif, onAccept, onReject }: NotificationComponentProps) => {
  ...
  return (
    <div className="bg-[#414141]/60 p-2 flex gap-2 rounded-sm hover:bg-[#414141] transition">
