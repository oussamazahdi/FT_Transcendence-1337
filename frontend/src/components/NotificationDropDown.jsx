  ...
  <div className="w-54 bg-[#414141]/70 p-1 flex rounded-[8px] gap-1 cursor-pointer hover:bg-[#414141]">
    ...
    <div className="flex flex-col items-center">
      <p className="text-[9px]">
        {notif.user.username} invite you to Ping Ping game
      </p>
      <div className="flex mt-1 gap-2">
        <button className="bg-[#8D4646] text-[8px] text-[#D63A3A] px-2 py-[2px] rounded-xs hover:bg-[#8D4646]/50 cursor-pointer">
          Reject
        </button>
        <button className="bg-[#468C74] text-[8px] text-[#3AD6A7] px-2 py-[2px] rounded-xs hover:bg-[#468C74]/50 cursor-pointer">
          Accept
        </button>
      </div>
    </div>
...
const FriendInvite = ({ notif }) => (
  <div className="w-54 bg-[#414141]/70 p-1 flex rounded-[8px] gap-1 cursor-pointer hover:bg-[#414141]">
    ...
    <div className="flex flex-col items-center">
      <p className="text-[9px]">
        {notif.user.username} send you friend invitation
      </p>
      <div className="flex mt-1 gap-2">
        <button className="bg-[#8D4646] text-[8px] text-[#D63A3A] px-2 py-[2px] rounded-xs hover:bg-[#8D4646]/50 cursor-pointer">
          Reject
...
const NotificationData = [
  {
    id: "1",
    user: { id: "", username: "Sarif", avatar: assets.soufiixPdp },
  ...
  },
  {
    ...
    user: { id: "", username: "Sarif", avatar: assets.soufiixPdp },
    type: "message",
    message: "hello, how are you! can we play a game bla bla",
  },
  {
    id: "3",
    user: { id: "", username: "Sarif", avatar: assets.soufiixPdp },
  ...
  return (
    <div ref={ref} className="relative hidden md:block">
      <button
        ...
        className="md:border border-[#9D9D9D]/40 rounded-[10px] md:p-3 hover:bg-[#000000]/40 cursor-pointer hover:scale-105 active:scale-95"
      >
