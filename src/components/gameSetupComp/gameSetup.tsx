...
//                     gameData.player1Avatar = a.color;
//                   }}
//                 />
//               ))}
//             </div>
...
//               value={nickname1}
//               onChange={(e) => {setNickname1(e.target.value); gameData.player1NickName = e.target.value}}
//             />
//           </div>
...
//                     gameData.player2Avatar = a.color;
//                   }}
//                 />
//               ))}
//             </div>
...
//               className="p-2 rounded-md bg-[#848484]/40 text-white placeholder-gray-400 text-sm w-full"
//               value={nickname2}
//               onChange={(e) => {setNickname2(e.target.value); gameData.player2NickName = e.target.value}}
//             />
//           </div>
//         </div>
...
//           <button onClick={onClose} className="text-gray-400 hover:text-red-400 transition">Close</button>
//         </div>
...
//                   <button
//                     key={c.name}
//                     className={`w-10 h-10 ${c.class} rounded-md border border-gray-400 hover:scale-110 transition-transform`}
//                     onClick={() => gameData.paddleColor = c.class}/> ))}
//               </div>
...
//                     key={c.name}
//                     className={`w-10 h-10 ${c.class} rounded-md border border-gray-400 hover:scale-110 transition-transform`}
//                     onClick={() => gameData.ballColor = c.class}/> ))}
//               </div>
...
//                     key={c.name}
//                     className={`w-10 h-10 ${c.class} rounded-md border border-gray-400 hover:scale-110 transition-transform`}
//                     onClick={() => gameData.boardColor = c.class}/> ))}
//               </div>
...
//           <div className='mb-8' >
//             <Slider className="max-w-md" color="foreground" defaultValue={0}
//               label="Score Limit" maxValue={15} minValue={5}
//               showSteps={true} size="md" step={1} onChange={(value) => (gameData.scoreLimit = value)} />
//             <h4 className='text-sm text-gray-400/65 pt-1'>First player to reach this score wins</h4>
//           </div>

//           <div className='mb-8' >
//             <Slider className="max-w-md" color="foreground" defaultValue={0.2}
//               label="Ball Speed" maxValue={3} minValue={1}
//               showSteps={true} size="md" step={1} onChange={(value) => (gameData.ballSpeed = value)} />
//             <h4 className='text-sm text-gray-400/65 pt-1'>Adjust the speed of the ball</h4>
//           </div>

//           <div className='mb-9' >
//             <Slider className="max-w-md" color="foreground" defaultValue={0.2}
//               label="Paddle Size" maxValue={4} minValue={1}
//               showSteps={true} size="md" step={1} onChange={(value) => (gameData.paddleSize = value)}/>
//             <h4 className='text-sm text-gray-400/65 pt-1'>Change the height of the paddles</h4>
//           </div>
//         </div>
...
//         <div className="flex justify-between mt-6">
//           <button className="text-gray-400 hover:text-white transition">Prev</button>
//           <Link href="/game/pingo">
//             <button 
//               className="text-gray-400 hover:text-white hover:bg-[#848484]/30 rounded-full px-4 py-1 transition"
//               onClick={() => {setWizardForm(2);console.log("outside useEffect");}}
//               >
//               Next
//               </button>
//             </Link>
          ...
          <div className="flex flex-col items-center border border-dashed border-gray-500/60 rounded-xl p-6">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-2 mb-4">
              {avatars.map((a) => (
                <img
                  ...
                  onClick={() => {
                    setSelectedAvatar1(a.color);
                    setGameData(prev => ({ ...prev, player1Avatar: a.color }));
                  }}
                />
              ))}
            </div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setGameData(prev => ({ ...prev, player1NickName: e.target.value }));
              }}
            />
          </div>
          ...
          <div className="flex flex-col items-center border border-dashed border-gray-500/60 rounded-xl p-6">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-2 mb-4">
              {avatars.map((a) => (
                <img
                  ...
                  onClick={() => {
                    setSelectedAvatar2(a.color);
                    setGameData(prev => ({ ...prev, player2Avatar: a.color }));
                  }}
                />
              ))}
            </div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setGameData(prev => ({ ...prev, player2NickName: e.target.value }));
              }}
            />
          </div>
        </div>
      ...
      <div className="relative bg-[#3C3C3C]/80 backdrop-blur-md p-6 rounded-3xl shadow-lg w-full max-w-4xl m-3">
        ...
        <div className="grid md:grid-cols-2 gap-6">          
          ...
          <div className="self-start items-center border border-dashed border-gray-500/60 rounded-xl p-6">
            ...
            <div className='mb-8' >
              <Slider className="max-w-md" color="foreground" defaultValue={5}
                label="Score Limit" maxValue={15} minValue={5}
                showSteps={true} size="md" step={1} onChange={(value) => setGameData(prev => ({ ...prev, scoreLimit: value }))} />
              <h4 className='text-sm text-gray-400/65 pt-1'>First player to reach this score wins</h4>
            </div>

            <div className='mb-8' >
              <Slider className="max-w-md" color="foreground" defaultValue={1}
                label="Ball Speed" maxValue={3} minValue={1}
                showSteps={true} size="md" step={1} onChange={(value) => setGameData(prev => ({ ...prev, ballSpeed: value }))} />
              <h4 className='text-sm text-gray-400/65 pt-1'>Adjust the speed of the ball</h4>
            </div>
            ...
            <div className='mb-9' >
              <Slider className="max-w-md" color="foreground" defaultValue={1}
                label="Paddle Size" maxValue={4} minValue={1}
                showSteps={true} size="md" step={1} onChange={(value) => setGameData(prev => ({ ...prev, paddleSize: value }))}/>
              <h4 className='text-sm text-gray-400/65 pt-1'>Change the height of the paddles</h4>
            </div>
          </div>
        ...
        <div className="flex justify-between mt-6">
          ...
          <Link href="/game/pingo">
            <button 
              className="text-gray-400 hover:text-white hover:bg-[#848484]/30 rounded-full px-4 py-1 transition"
              onClick={() => console.log("outside useEffect")}
            >
              Play
            </button>
          </Link>
